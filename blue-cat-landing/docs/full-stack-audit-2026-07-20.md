...
> **Documento histórico.** Los hallazgos reflejan el estado del 20 de julio de 2026. El Sprint 2 reemplazó el bearer administrativo compartido por sesiones individuales de operador con MFA, agregó migraciones versionadas y dejó la recepción de pagos bloqueada por configuración. Consulte `portal-identity.md` y `SPRINT_2_ACCEPTANCE.md` para el estado vigente; los riesgos de archivos, conciliación y segregación financiera siguen abiertos para el Sprint 3.
