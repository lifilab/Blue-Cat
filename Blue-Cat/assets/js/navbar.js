document.addEventListener('DOMContentLoaded', function () {
  ...
  fetch('../assets/api/core.php', {
    ...
    .then(function (data) {
      ...
      var allowed = {}; for (var j=0;j<modulos.length;j++) allowed[modulos[j].codigo]=true;
      document.querySelectorAll('.dash-card').forEach(function(card) {
        ...
        var aliases={pos:'pos',punto_de_venta:'pos',inicio:'inicio',cuadre_de_ventas:'ventas'};
        var code=aliases[href]||href; if(!allowed[code]) card.style.display='none';
      });
